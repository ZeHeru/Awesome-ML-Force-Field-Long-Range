...
- [ExtendedSystems_MLP_Review_Behler_Csanyi_EPJB_2021.mmd](ExtendedSystems_MLP_Review_Behler_Csanyi_EPJB_2021.mmd) - Extended systems and periodic boundary conditions
- [FourGen_NNP_Review_Behler_ChemRev_2021.mmd](FourGen_NNP_Review_Behler_ChemRev_2021.mmd) - Fourth-generation neural network potentials
...
- [FourGen_NNP_AccChemRes_Ko_2021.mmd](FourGen_NNP_AccChemRes_Ko_2021.mmd) - Fourth-generation NNP overview
...
- [Long-Range_Electrostatics_Made_Easier.mmd](Long-Range_Electrostatics_Made_Easier.mmd) - Simplified approach to long-range electrostatics
...
### Multipoles and Advanced Descriptors
...
- [Alanine_Kriging_Mills_Popelier_TCA_2012.mmd](Alanine_Kriging_Mills_Popelier_TCA_2012.mmd) - Kriging for alanine dipeptide
...
### Application Studies
- [NNP_WaterClusters_Morawietz_Behler_JPCA_2013.mmd](NNP_WaterClusters_Morawietz_Behler_JPCA_2013.mmd) - Water clusters with NNP
- [ZnO_NNP_Artrith_Morawietz_Behler_PRB_2011.mmd](ZnO_NNP_Artrith_Morawietz_Behler_PRB_2011.mmd) - ZnO neural network potential
- [Phosphorus_GAP_Deringer_NatComm_2020.mmd](Phosphorus_GAP_Deringer_NatComm_2020.mmd) - Phosphorus GAP potential
- [C60_PhaseDiagram_Muhli_PRB_2021.mmd](C60_PhaseDiagram_Muhli_PRB_2021.mmd) - C60 phase diagram
...
### Core Papers
- ✅ ~~DPLR (Deep Potential Long Range, 2022)~~ - **Added!**
...
**Note**: If you have created mind maps for any of the papers listed above, please add them to this folder and update this README.
